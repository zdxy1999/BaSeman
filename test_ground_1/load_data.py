...
from dataloaders.LSCIDMR_dataset_2401 import MLC_Dataset_2401,MLC_Dataset_2401_shuffle_aug
...
def get_data(args):
    ...
    if dataset == 'coco':
        ...
        train_csv = '/opt/data/private/49_backup/DataSets/MLC_16c/check/multi_train_shuffled_checked.csv'
        ...
        valid_csv = '/opt/data/private/49_backup/DataSets/MLC_16c/check/multi_valid_checked.csv'
        # '/data/zdxy/DataSets/MLC_16c/lables/multi_valid.csv'
        # '/data/zdxy/DataSets/MLC_16c/lables_try/multi_valid.csv'

        test_csv = '/opt/data/private/49_backup/DataSets/MLC_16c/check/multi_test_checked.csv'
        ...
        # todo:数据集文件路径修改
        folder = '/opt/data/private/49_backup/DataSets/MLC_16c/small_whole/'
        #'/data/zdxy/DataSets/2401_data/2019_0020'
        ...
        # '/data/zdxy/DataSets/MLC_16c/lables_try/multi_train.csv'
        # '/data/zdxy/DataSets/MLC_16c/lables/multi_train_shuffled.csv'
        # '/data/zdxy/DataSets/MLC_16c/cleaned_fang/multi_train_shuffled_cleaned.csv'
        # '/data/zdxy/DataSets/MLC_16c/check/multi_train_shuffled_checked.csv'
        # '/data/zdxy/DataSets/MLC_16c/cleaned_fang_retrained/multi_train_shuffled_cleaned.csv'

        # 249
        # '/data/zdxy/DataSets/MLC_16c/check/multi_train_shuffled_checked.csv'
        if args.soft_label:
            train_csv = '/data/zdxy/DataSets/MLC_16c/soft/multi_train_shuffled_soft.csv'

        # todo:数据集文件路径修改
        valid_csv = '/opt/data/private/49_backup/DataSets/MLC_16c/check/multi_valid_checked.csv'
        # '/data/zdxy/DataSets/MLC_16c/lables/multi_valid.csv'
        # '/data/zdxy/DataSets/MLC_16c/lables_try/multi_valid.csv'
        # '/data/zdxy/DataSets/MLC_16c/cleaned_fang/multi_valid_cleaned.csv'
        # '/data/zdxy/DataSets/MLC_16c/check/multi_valid_checked.csv'
        # '/data/zdxy/DataSets/MLC_16c/cleaned_fang_retrained/multi_valid_cleaned.csv'

        # todo:数据集文件路径修改
        test_csv = '/opt/data/private/49_backup/DataSets/MLC_16c/check/multi_test_checked.csv'
        # '/data/zdxy/DataSets/MLC_16c/lables/multi_test.csv'
        # '/data/zdxy/DataSets/MLC_16c/lables_try/multi_test.csv'
        # '/data/zdxy/DataSets/MLC_16c/cleaned_fang/multi_test_cleaned.csv'
        # '/data/zdxy/DataSets/MLC_16c/check/multi_test_checked.csv'
        # '/data/zdxy/DataSets/MLC_16c/cleaned_fang_retrained/multi_test_cleaned.csv'
        ...
        test_dataset.dataset.transform = test_trans
        '''
    elif dataset == 'LSCIDMR_16c_shuffle_aug':
        folder = '/data/zdxy/DataSets/2401_data'
        # '/data/zdxy/DataSets/2401_data/2019_0020'
        # '/data/zdxy/DataSets/MLC_16c/small_whole'
        # '/data/zdxy/DataSets/MLC_16c/hdf5_original'
        # '/data/zdxy/DataSets/MLC_16c/hdf5_try'
        ...
        train_dataset = MLC_Dataset_2401_shuffle_aug(train_csv, folder,
                                         num_labels=17,
                                         known_labels=args.train_known_labels,
                                         transform=train_trans,  # torchvision.transforms.ToTensor(),
                                         testing=False,
        ...
        valid_dataset = MLC_Dataset_2401_shuffle_aug(valid_csv, folder,
                                         num_labels=17,
                                         known_labels=args.train_known_labels,
                                         transform=test_trans,  # torchvision.transforms.ToTensor(),
                                         testing=True,
        ...
        test_dataset = MLC_Dataset_2401_shuffle_aug(test_csv, folder,
                                        num_labels=17,
                                        known_labels=args.train_known_labels,
                                        transform=test_trans,  # torchvision.transforms.ToTensor(),
                                        testing=True,
    ...
    if train_dataset is not None:
        train_loader = DataLoader(train_dataset, batch_size=batch_size,shuffle=False, num_workers=workers,drop_last=drop_last,
